...
class Feed implements \Suin\RSSWriter\FeedInterface
{
	...
	{
		$xml = new SimpleXMLElement('<?xml version="1.0" encoding="UTF-8" ?><rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" version="2.0">', LIBXML_NOERROR|LIBXML_ERR_NONE|LIBXML_ERR_FATAL);
